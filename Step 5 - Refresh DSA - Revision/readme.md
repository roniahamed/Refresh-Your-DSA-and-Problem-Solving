# # Step 5: Refresh DSA & Problem Solving - Revision | LeetCode Problem Solving
...
[![Revision Complete](https://img.shields.io/badge/Revision-Complete-success?style=for-the-badge)](https://github.com/)

---

## 📖 আসসালামু আলাইকুম!

আপনি অনেক আগ্রহ নিয়ে নতুন একটা টপিক শিখলেন, বেশ কয়েকটি প্রবলেমও সমাধান করলেন। কিন্তু মাসখানেক পর যখন আবার সেই টপিকে ফিরে এলেন, দেখলেন প্রায় সবই ভুলে গেছেন! পরিচিত লাগছে, তাই না?
...
### 🎯 ফোকাস টপিকস
- **Array Manipulation** - অ্যারে নিপুণতা
- **Stack Operations** - স্ট্যাক অপারেশন
- **Two Pointers Technique** - দুই পয়েন্টার পদ্ধতি
- **Sliding Window Algorithm** - স্লাইডিং উইন্ডো অ্যালগরিদম
...
### 💪 Hard Problems যেগুলো জয় করেছি:

1. **🔥 Largest Rectangle in Histogram** - Stack optimization technique
2. **💧 Trapping Rain Water** - Two pointers mastery  
3. **🪟 Sliding Window Maximum** - Deque implementation
4. **🎯 Minimum Window Substring** - Advanced sliding window
5. **📊 Maximal Rectangle** - 2D histogram approach
...
- **Step 7:** Dynamic Programming Deep Dive  
- **Step 8:** System Design Fundamentals
- **Step 9:** Mock Interview Preparation
...
- **GitHub:** [আপনার GitHub Profile]
- **LeetCode:** [আপনার LeetCode Profile]  
- **LinkedIn:** [আপনার LinkedIn Profile]
- **Email:** [আপনার Email]
...
আপনি অনেক আগ্রহ নিয়ে নতুন একটা টপিক শিখলেন, বেশ কয়েকটি প্রবলেমও সমাধান করলেন। কিন্তু মাসখানেক পর যখন আবার সেই টপিকে ফিরে এলেন, দেখলেন প্রায় সবই ভুলে গেছেন! পরিচিত লাগছে, তাই না?

সত্যি বলতে, শেখার এই পদ্ধতিতে খুব ছোট একটা সমস্যা আছে। শুধু নতুন জিনিস শিখে এগিয়ে যাওয়াই যথেষ্ট নয়। জ্ঞানকে নিজের মধ্যে ধরে রাখতে না পারলে সেই শেখার কোনো মানেই থাকে না। আপনাকে শেখার স্টাইল বদলাতে হবে, যাতে জ্ঞানটা শুধু সাময়িক না হয়ে দীর্ঘস্থায়ী হয়।

এর সবচেয়ে ভালো উপায় হলো, শেখার সময় কঠিন বিষয়গুলো থেকে মূল পয়েন্ট নোট করে রাখা এবং নিয়মিত পুরনো টপিকগুলো রিভিশন দেওয়া। আমি মূলত এভাবেই শিখি আর তাই আমার শেখা বিষয়গুলো বেশিদিন মনে থাকে। আজকে আপনাদের সাথে আমার এই শেখার পদ্ধতির একটি বাস্তব অভিজ্ঞতা শেয়ার করছি।

---

আলহামদুলিল্লাহ, LeetCode-এ আমার টানা **১৯৬+ দিনের** কোডিং স্ট্রিক চলছে! এই দীর্ঘ পথচলায় আপনাদের সবার সাপোর্ট আর ভালোবাসা আমাকে সবসময় অনুপ্রাণিত করেছে। এই রিপোজিটরিতে আমি আমার "Refresh DSA & Problem Solving" জার্নির **Step 5: রিভিশন পর্ব** শেয়ার করছি।

আগের ধাপগুলোতে নতুন নতুন অনেক টপিক (যেমন Two Pointers, Sliding window, Stack) ইত্যাদি নিয়ে কথা বলেছিলাম। তবে কিছুদিন আগে আমার মনে হলো, শুধু শিখলেই হবে না, যেগুলো সমাধান করতে একটু সমস্যা হয় বা কনসেপ্টগুলোকে কঠিন লাগে, সেগুলো আবার ঝালিয়ে নেওয়াটা খুব জরুরি। কারণ, **ভিত্তি শক্ত না হলে উপরে ওঠা কঠিন।**

এই ধাপে আমি বিভিন্ন টপিকের বাছাই করা **মোট ৪৫টি প্রবলেম** আবার সমাধান করেছি, যার মধ্যে ছিল:
*   **Easy:** ১৫টি
*   **Medium:** ২২টি
*   **Hard:** ৮টি

এই রিভিশনের ফলে অনেক পুরনো কনসেপ্ট যেগুলো প্রায় ঝাপসা হয়ে গিয়েছিল, সেগুলো আবার নতুন করে মাথায় গেঁথে গেছে। বিশেষ করে `Largest Rectangle in Histogram`, `Trapping Rain Water`, `Sliding Window Maximum` এবং `Minimum Window Substring` এর মতো হার্ড প্রবলেমগুলো আবার করতে গিয়ে সেগুলোর ভেতরের লজিকগুলো আরও ভালোভাবে ধরতে পেরেছি। মনে হচ্ছে যেন নিজের মাঝে আবার নতুন করে আত্মবিশ্বাস জন্ম নিলো! 😅

---

## 📝 আমার ১৫ দিনের রিভিশন প্ল্যান

এখানে আমার ১৫ দিনের রিভিশন প্ল্যানটি দেওয়া হলো। প্রতিটি প্রবলেমের পাশে LeetCode লিংক যুক্ত করা আছে।

| দিন | টপিক(সমূহ) | সমস্যা (Problem Name) | LeetCode Link |
| :---: | :--- | :--- | :---: |
| **Day 1** | Array, Stack, Two Pointer | 1. Two Sum (Easy) | [Link](https://leetcode.com/problems/two-sum/) |
...
| **Day 2** | Stack, Array, Sliding Window | 1. Score of Parentheses (Medium) | [Link](https://leetcode.com/problems/score-of-parentheses/) |
| | | 2. Maximum Subarray (Medium) | [Link](https://leetcode.com/problems/maximum-subarray/) |
| | | 3. Best Time to Buy and Sell Stock (Easy) | [Link](https://leetcode.com/problems/best-time-to-buy-and-sell-stock/) |
| **Day 3** | Stack, Two Pointer, Sliding Window | 1. Min Stack (Medium) | [Link](https://leetcode.com/problems/min-stack/) |
| | | 2. Container With Most Water (Medium) | [Link](https://leetcode.com/problems/container-with-most-water/) |
...
| **Day 4** | Stack, Array, Two Pointer | 1. Next Greater Element I (Easy) | [Link](https://leetcode.com/problems/next-greater-element-i/) |
| | | 2. Product of Array Except Self (Medium) | [Link](https://leetcode.com/problems/product-of-array-except-self/) |
| | | 3. Reverse String (Easy) | [Link](https://leetcode.com/problems/reverse-string/) |
| **Day 5** | Stack, Two Pointer, Sliding Window | 1. Daily Temperatures (Medium) | [Link](https://leetcode.com/problems/daily-temperatures/) |
| | | 2. Two Sum II - Input Array Is Sorted (Medium) | [Link](https://leetcode.com/problems/two-sum-ii-input-array-is-sorted/) |
| | | 3. Permutation in String (Medium) | [Link](https://leetcode.com/problems/permutation-in-string/) |
| **Day 6** | Stack, Array, Two Pointer | 1. Backspace String Compare (Easy) | [Link](https://leetcode.com/problems/backspace-string-compare/) |
| | | 2. Longest Consecutive Sequence (Medium) | [Link](https://leetcode.com/problems/longest-consecutive-sequence/) |
| | | 3. Move Zeroes (Easy) | [Link](https://leetcode.com/problems/move-zeroes/) |
| **Day 7** | Stack, Array, Sliding Window | 1. Evaluate Reverse Polish Notation (Medium) | [Link](https://leetcode.com/problems/evaluate-reverse-polish-notation/) |
| | | 2. Group Anagrams (Medium) | [Link](https://leetcode.com/problems/group-anagrams/) |
| | | 3. Maximum Average Subarray I (Easy) | [Link](https://leetcode.com/problems/maximum-average-subarray-i/) |
| **Day 8** | Stack, Two Pointer, Array | 1. Make the String Great (Easy) | [Link](https://leetcode.com/problems/make-the-string-great/) |
| | | 2. 3Sum (Medium) | [Link](https://leetcode.com/problems/3sum/) |
| | | 3. Valid Anagram (Easy) | [Link](https://leetcode.com/problems/valid-anagram/) |
| **Day 9** | Stack, Two Pointer, Sliding Window | 1. Remove K Digits (Medium) | [Link](https://leetcode.com/problems/remove-k-digits/) |
| | | 2. Remove Nth Node From End of List (Medium) | [Link](https://leetcode.com/problems/remove-nth-node-from-end-of-list/) |
| | | 3. Find All Anagrams in a String (Medium) | [Link](https://leetcode.com/problems/find-all-anagrams-in-a-string/) |
| **Day 10** | Stack, Array, Two Pointer | 1. Largest Rectangle in Histogram (Hard) | [Link](https://leetcode.com/problems/largest-rectangle-in-histogram/) |
| | | 2. Top K Frequent Elements (Medium) | [Link](https://leetcode.com/problems/top-k-frequent-elements/) |
| | | 3. Middle of the Linked List (Easy) | [Link](https://leetcode.com/problems/middle-of-the-linked-list/) |
| **Day 11** | Stack, Two Pointer, Sliding Window | 1. Asteroid Collision (Medium) | [Link](https://leetcode.com/problems/asteroid-collision/) |
| | | 2. Trapping Rain Water (Hard) | [Link](https://leetcode.com/problems/trapping-rain-water/) |
| | | 3. Minimum Size Subarray Sum (Medium) | [Link](https://leetcode.com/problems/minimum-size-subarray-sum/) |
| **Day 12** | Stack, Two Pointer, Sliding Window | 1. Next Greater Element II (Medium) | [Link](https://leetcode.com/problems/next-greater-element-ii/) |
| | | 2. Valid Palindrome II (Easy) | [Link](https://leetcode.com/problems/valid-palindrome-ii/) |
| | | 3. Maximum Number of Vowels in a Substring of Given Length (Medium) | [Link](https://leetcode.com/problems/maximum-number-of-vowels-in-a-substring-of-given-length/) |
| **Day 13**| Stack, Two Pointer, Sliding Window | 1. Remove All Adjacent Duplicates In String (Easy) | [Link](https://leetcode.com/problems/remove-all-adjacent-duplicates-in-string/) |
| | | 2. Linked List Cycle II (Medium) | [Link](https://leetcode.com/problems/linked-list-cycle-ii/) |
...
| **Day 14**| Stack, Stack, Sliding Window | 1. Maximal Rectangle (Hard) | [Link](https://leetcode.com/problems/maximal-rectangle/) |
| | | 2. Implement Stack using Queues (Easy) | [Link](https://leetcode.com/problems/implement-stack-using-queues/) |
| | | 3. Sliding Window Maximum (Hard) | [Link](https://leetcode.com/problems/sliding-window-maximum/) |
| **Day 15**| Array, Sliding Window, Array | 1. Encode and Decode Strings (Hard) | [Premium Link](https://leetcode.com/problems/encode-and-decode-strings/) |
...
*   আপনি এই ১৫ দিনের প্ল্যানটি অনুসরণ করে আপনার DSA রিভিশন শুরু করতে পারেন।
*   প্রতিটি প্রবলেম প্রথমে নিজে সমাধান করার চেষ্টা করুন।
*   কোথাও আটকে গেলে বা কনসেপ্ট বুঝতে সমস্যা হলে কমিউনিটির সাহায্য নিন।
*   মূল লক্ষ্য হলো প্রতিটি প্রবলেমের পেছনের লজিকটা ভালোভাবে বোঝা।

আমার এই ১৯৬+ দিনের স্ট্রিক আর এই রিভিশন পর্ব যদি আপনাদের একটুও অনুপ্রাণিত করে, সেটাই আমার সার্থকতা। পরবর্তী চ্যালেঞ্জের জন্য প্রস্তুত! 💪

## ⭐ সাপোর্ট
এই প্রচেষ্টাটি যদি আপনার ভালো লেগে থাকে এবং আপনাকে সাহায্য করে, তাহলে রিপোজিটরিটি স্টার (⭐) করতে ভুলবেন না! এটি আমাকে আরও এমন রিসোর্স তৈরি করতে অনুপ্রাণিত করবে।
